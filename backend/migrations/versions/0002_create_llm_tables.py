...
Revision ID: 0002_create_llm_tables
Revises: 0001_create_platform_tables
...
revision = "0002_create_llm_tables"
down_revision = "0001_create_platform_tables"
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("created_by", sa.String(length=36), sa.ForeignKey("iam_users.id"), nullable=True),
