...
Revision ID: 0003_create_knowledge_tables
Revises: 0002_create_llm_tables
...
revision = "0003_create_knowledge_tables"
down_revision = "0002_create_llm_tables"
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("created_by", sa.String(length=36), sa.ForeignKey("iam_users.id"), nullable=False),
